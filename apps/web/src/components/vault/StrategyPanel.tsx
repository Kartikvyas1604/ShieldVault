    ...
    return (
      <div className="glass-card p-6">
        <div className="h-[300px] flex items-center justify-center">
          <div className="text-[#666666] font-mono text-sm animate-pulse">Loading...</div>
        </div>
      </div>
    );
  }
      ...
      <>
        <div className="glass-card p-6">
          ...
          <div className="h-[200px] flex flex-col items-center justify-center gap-4">
            ...
            <Button size="sm" onClick={() => setShowCreate(true)}>Configure Strategy</Button>
          </div>
        </div>
        {showCreate && (
          <CreateStrategyModal
    ...
    <>
      <div className="glass-card rounded-sm">
        ...
        >
          ...
          {activeStrategy.timeLimit && (
            <div>
              <div className="text-xs font-mono text-[#666666] uppercase tracking-wider mb-2">
                Auto-Close Timeout
              </div>
              <div className="text-sm font-mono text-[#FFB800]">
                {activeStrategy.timeLimit >= 60 ? `${activeStrategy.timeLimit / 60}h` : `${activeStrategy.timeLimit}m`}
              </div>
            </div>
          )}
